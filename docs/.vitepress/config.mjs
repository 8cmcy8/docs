      ...
      '/个人经历/': [
        {
          ...
          collapsed: false,  
          items: [
            { text: '第一次', link: '/个人经历/日常记录/第一次' },
            { text: '第二次', link: '/个人经历/日常记录/第二次' },
            { text: '第三次', link: '/个人经历/日常记录/第三次' },
            { text: '第四次', link: '/个人经历/日常记录/第四次' },
            { text: '第五次', link: '/个人经历/日常记录/第五次' },
            { text: '第六次', link: '/个人经历/日常记录/第六次' },
            { text: '第七次', link: '/个人经历/日常记录/第七次' },
            { text: '第八次', link: '/个人经历/日常记录/第八次' },
            { text: '第九次', link: '/个人经历/日常记录/第九次' },
          ],
        },
        {
          text: '阶段总结', 
         ...
         items:[
           ...
           { text: '大二上开学总结', link: '/个人经历/总结/大二上开学总结' },
           { text: '大二上半段总结', link: '/个人经历/总结/大二上半段总结' },
           { text: '大二下开学总结', link: '/个人经历/总结/大二下开学总结' },
         ],
       },
      ],
    },
